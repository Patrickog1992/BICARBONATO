...
import { CalendarIcon, Loader2, Music, Sparkles, Mail, Phone, CheckCircle } from 'lucide-react';
...
export default function CreateMorangoNoteForm() {
    ...
    const stepHeaders = [
        { title: "Título para o Morango do Amor", description: "Escreva o titulo dedicatório para a página. Ex: Para o meu docinho!" },
        { title: "Sua mensagem especial", description: "Escreva uma mensagem doce e carinhosa." },
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormControl>
                                                <Input 
                                                    placeholder="Ex: Para o meu docinho!" 
                                                    {...field} 
                                                />
                                            </FormControl>
                                            <FormMessage />
              ...
              <div className="sticky top-24">
                  <Card className="relative mx-auto border-neutral-800 bg-neutral-900 border-[8px] rounded-[2.5rem] h-[550px] w-[270px] shadow-xl">
                      ...
                      <CardContent className="rounded-[2rem] overflow-auto w-full h-full bg-black p-0">
                           <AnimationBackground animation="emojis" emojis="🍓❤️">
                            <div className="text-white space-y-2 text-center p-4 pt-8">
                                <h1 className="font-headline text-2xl font-bold text-pink-400">{formData.title || "Seu título aparecerá aqui"}</h1>
