...
export default function VSLPage() {
  ...
  const comments = [
    ...
    { name: "Celia Ivano", text: "Wagner o negócio fica igual concreto rsrs Esse metodo foi a única tentativa que deu certo pra mim. Pode testar, vc vai ver como funciona!", likes: 11, image: "https://i.imgur.com/J4omSDG.jpeg" },
    { name: "Diego Silva", text: "Já fazia três anos que eu não conseguia levantar o mastro tentei de tudo gel massagem e nada funcionava. So esse metodo que conseguiu me salva só não use muito senão não tem quem faça descer o meninão!!", likes: 18, image: "https://i.imgur.com/Mgtjt2s.jpeg" },
    { name: "João paulo", text: "Valeu, vou testar também!", likes: 14, image: "https://i.imgur.com/Uxfn3tt.jpeg" },
    { name: "Otavio Neto", text: "Fazia tempo que estava procurando isso, sorte que achei de novo", likes: 5, image: "https://i.imgur.com/lUUhU1Y.jpeg" },
